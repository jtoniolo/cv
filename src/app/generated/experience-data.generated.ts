  ...
  experience: [
    {
      ...
      positions: [
          ...
          projects: [
            {
              ...
              challenges:
                'Faced a lack of knowledge transfer and limited resources. Overcame these challenges through effective use of tools, extensive troubleshooting experience, and efficient time management.',
              achievements:
                'Successfully eliminated maintenance, support, and enhancement backlog. Received awards for excellence in contributions.',
              keywords: [
                'Angular',
                'ASP.NET Core',
                'SQL Server',
            ...
            },
            {
              ...
              responsibilities:
                'Modernized the Economic Substance app by eliminating outdated third-party dependencies and switching to the current version of .NET (version 7 at the time). Chose ABP Framework for rapid development.',
              technologies: [
                'ASP.NET Core',
                'Angular',
                'MongoDB',
              ...
              achievements:
                'Implemented Microservice best practices with queue-based, cross-service communication, resulting in a more stable and performant design. Switched to an ElasticSearch index, dramatically increasing search performance from minutes to seconds.',
              keywords: [
                'ASP.NET Core',
                'Angular',
                'MongoDB',
            ...
            },
            {
              ...
              role: 'Developer',
              responsibilities:
                'Cleaned up a RAG app built in Python and React. Converted the API from an ad-hoc structure to a proper RESTful API following development best practices.',
              technologies: ['Python', 'React', 'Azure OpenAI'],
              achievements:
                'Refactored the API to comply with the RESTful pattern, resulting in a more standardized and maintainable application. Collaborated with another developer to update the React UI in parallel.',
            ...
            },
            {
              ...
              responsibilities:
                'Helped build a UI refresh for the application using Angular, Angular Material, and NgRx.',
              technologies: ['Angular', 'Angular Material', 'NgRx'],
              challenges:
                'Faced a lack of clear requirements and documentation for the first version of the app, which was built by a different company. Successfully reverse-engineered the functionality by analyzing the code and simulating its use.',
        ...
        },
        {
          ...
          endDate: '2013-01-14',
          responsibilities: [
            'Developed a suite of back-end tools for APT using C# and VB.Net',
            'Developed an inventory tool using MS SQL Database',
            'Developed a support tool for MS Groove',
      ...
      positions: [
        {
          ...
          responsibilities: [
            ...
            'Managed a team of 10 desktop support analysts and 2 voice analysts',
            'Promoted from PC/LAN Analyst to acting lead within 5 months',
          ],
          keywords: [
            'VB.Net',
            'MS SQL',
        ...
        {
          title: 'PC/LAN Analyst',
          startDate: '2006-07-01',
          endDate: '2006-12-31',
          responsibilities: [
            'Provided 2nd level support for all PC-related hardware and software',
          ],
          keywords: ['PC support', 'hardware', 'software', 'technical support'],
        },
      ],
    },
  ],
    ...
    categories: [
      {
        ...
        items: [
          ...
          'Scribe Insight',
          'ADX Studio/Portal for Dynamics 365',
          'Crystal Reports',
          'Word',
          'Excel',
          'Access',
        ...
        keywords: ['CRM', 'reporting', 'office software', 'productivity tools'],
      },
      {
      ...
      {
        name: 'Languages',
        items: ['C#', 'JavaScript', 'HTML5', 'T-SQL', 'VB', 'VB Script', 'VBA'],
