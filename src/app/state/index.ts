...
export const selectFilteredCompanies = Selectors.selectFilteredCompanies;
...
export const selectFilteredEducation = Selectors.selectFilteredEducation;
export const selectSkills = Selectors.selectSkills;
export const selectFilteredSkills = Selectors.selectFilteredSkills;
